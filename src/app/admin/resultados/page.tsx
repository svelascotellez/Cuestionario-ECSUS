        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid var(--card-border)', textAlign: 'left' }}>
              ...
              <th style={{ padding: '1rem' }}>S.T. Equipo</th>
              <th style={{ padding: '1rem' }}>S.T. Internet</th>
              <th style={{ padding: '1rem' }}>S.T. Impresora</th>
          ...
          <tbody>
            {results.map((item) => {
              ...
              return (
                <tr key={item.id} style={{ borderBottom: '1px solid var(--card-border)' }}>
                  ...
                  <td style={{ padding: '1rem' }}>{tech.equipo}</td>
                  <td style={{ padding: '1rem' }}>{tech.internet}</td>
                  <td style={{ padding: '1rem' }}>{tech.impresora}</td>
            ...
            {results.length === 0 && (
              <tr>
                <td colSpan={12} style={{ padding: '2rem', textAlign: 'center' }}>No hay resultados aún.</td>
              </tr>
            )}
          </tbody>
        </table>
